...
//       }
//       res.json(
//         successResponse(response.cart, "Item added to cart successfully")
//       );
//     }
//   );
// });
...
//         return res.status(500).json(errorResponse(err.message));
//       }
//       res.json(successResponse(response.cart, "Cart updated successfully"));
//     }
//   );
// });
...
// // Get all cart items
// router.get("/", (req, res) => {
//   cartClient.getCart({}, createMetadata(req), (err, response) => {
//     if (err) {
//       return res.status(500).json(errorResponse(err.message));
//     }
//     res.json(successResponse(response.carts, "Cart fetched successfully"));
//   });
// });
